<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('activity_modes.list')">
                                    Modes
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('activity_types.list')">
                                    Types
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @can('manage-activities')
            <div class="pb-3 space-y-1 border-t border-gray-200">
                <div class="px-4 py-3">
                    <div class="font-extrabold text-lg text-gray-800">Activities</div>
                </div>
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('activities.index')" :active="request()->routeIs('categories.index')">
                        <div class="ml-4">Activities</div>
                    </x-responsive-nav-link>
                </div>
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('activity_modes.list')" :active="request()->routeIs('categories.index')">
                        <div class="ml-4">Modes</div>
                    </x-responsive-nav-link>
                </div>
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('activity_types.list')" :active="request()->routeIs('categories.index')">
                        <div class="ml-4">Type</div>
                    </x-responsive-nav-link>
                </div>
            </div>
        @endcan
