    ...
    <div class="max-w-5xl container">
      <div class="panel">
        ...
        <div class="w-11/12 flex gap-2">
          <div class="w-2/12 font-bold underline">Roles</div>
          <div class="w-4/12 font-bold underline">Email</div>
      ...
      @foreach($users as $user)
        <div class="border-b-2 sm:border-none mx-2 mt-2 sm:mt-0 pb-2 sm:pb-0 flex gap-2 hover:bg-gray-100"">
          <div class="w-4/5 sm:w-11/12 sm:flex gap-2">
            <div class="w-2/12 text-sm sm:text-lg">
            ...
            <div class="w-4/12 sm:truncate font-extrabold sm:font-normal">
